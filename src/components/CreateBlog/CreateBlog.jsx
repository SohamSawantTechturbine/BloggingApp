...
const handleFileChange = (e) => {
  ...
  return (
   ...
   <div className="flex flex-col h-screen bg-purple-100">
    <form method='POST' encType="multipart/form-data" onSubmit={addPost} className="flex flex-col">
        ...
        <div className="flex ml-5 mt-3">
            ...
            <button
                type='submit'
                className="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-8 py-2.5 text-center ml-10  mt-3"
            >
                Post
            </button>
        </div>
