            ...
            <nav className="bg-red border-gray-200 dark:bg-gray-900  mx-auto">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <div className="flex items-center">
                        <img src="https://images.g2crowd.com/uploads/product/image/social_landscape/social_landscape_c1d77aa57670df519b9381e574a9795e/blogify.png" className="h-8" alt="Flowbite Logo" />
